                          ...
                          column(width=12,
                                 ...
                                 fluidRow(
                                   column(width=12,
                                          flipBox(
                                            id = 1,
                                            main_img = "https://image.flaticon.com/icons/svg/679/679746.svg",
                                            header_img = "https://image.flaticon.com/icons/svg/1908/1908681.svg",
                                            front_title = "Please Upload Your Order Details File",
                                            back_title = "Summary",
                                            fluidRow(
                                              fileInput('file1', 'Insert File', accept = c(".xlsx")),align = "center"),
                                            fluidRow(
                                                ...
                                                footer = fluidRow(
                                                  ...
                                                  column(
                                                    ...
                                                    descriptionBlock(
                                                      ...
                                                      number_icon = "fa fa-caret-up",
                                                      header = "", 
                                                      text = h3("TOTAL MISSING VALUES IN LINK COLUMN"), 
                                                      right_border = FALSE,
                                                      margin_bottom = FALSE
                                                    )
                                                  )
                          ...
                          fluidPage(
                            column(width=12,
                                   fluidRow(
                                     ...
                                     # hr(),
                                     box(
                                     title = "Click play button to optimize the route", background = "maroon", solidHeader = TRUE, width = 12,
                                     leafletOutput("map1")
                                        ),
